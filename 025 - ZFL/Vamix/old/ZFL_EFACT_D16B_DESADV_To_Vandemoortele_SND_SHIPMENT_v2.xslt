<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//s0:Message/s0:Documents/s0:Document">
    ...
    <ns0:EFACT_D16B_DESADV>
      ...
      <xsl:for-each select="s0:DocumentLines/s0:DocumentLine[s0:Type='1'][s0:QtyOutstanding&lt;1]">
        ...
        <xsl:for-each select="s0:DocumentDetailLines/s0:DocumentDetailLine">
          ...
          <ns0:CPSLoop1>
            <ns0:CPS>
              ...
              <CPS02>
                <xsl:value-of select="MyScript:GetNRCounter3(1)"/>
              </CPS02>
            </ns0:CPS>
            <ns0:PACLoop1>
              <ns0:PAC>
        ...
        <xsl:if test="string-length(s0:QtyPosted)=0">
          <xsl:if test="MyScript:GetNRCounter3(0)=0">
            <ns0:CPSLoop1>
              <ns0:CPS>
                <CPS01>
                  <xsl:value-of select="MyScript:GetNRCounter(1)" />
      ...
      <xsl:for-each select="s0:DocumentLines/s0:DocumentLine[s0:Type='1'][s0:QtyOutstanding&gt;0]">
        <xsl:variable name="orderLineNumber" select="s0:Attributes/s0:Attribute[s0:Code='ORDERLINE']/s0:Value" />
        <xsl:variable name="LineNo" select="s0:Attributes/s0:Attribute[s0:Code='LINENO']/s0:Value"/>
