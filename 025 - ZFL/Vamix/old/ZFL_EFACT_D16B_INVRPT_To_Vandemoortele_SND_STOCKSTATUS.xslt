<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:key name="Group-by-MATNO-THT-BATCH-STATUS" match="//s0:Message/s0:Customers/s0:Customer/s0:Carriers/s0:Carrier" use="concat(s0:ContentLines/s0:CarrierContent/s0:CustomerItemNo,'-',s0:ContentLines/s0:CarrierContent/s0:ExpirationDate,'-',s0:ContentLines/s0:CarrierContent/s0:ExBatchNo,'-',s0:StatusCode)" />
  <xsl:template match="/">
  ...
  <xsl:template match="//s0:Message/s0:Customers/s0:Customer">
    <ns0:EFACT_D16B_INVRPT>
      ...
      <xsl:for-each select="//s0:Carrier[count(. | key('Group-by-MATNO-THT-BATCH-STATUS', concat(s0:ContentLines/s0:CarrierContent/s0:CustomerItemNo,'-',s0:ContentLines/s0:CarrierContent/s0:ExpirationDate,'-',s0:ContentLines/s0:CarrierContent/s0:ExBatchNo,'-',s0:StatusCode))[1]) = 1]">
        <xsl:variable name="LineKey" select="concat(s0:ContentLines/s0:CarrierContent/s0:CustomerItemNo,'-',s0:ContentLines/s0:CarrierContent/s0:ExpirationDate,'-',s0:ContentLines/s0:CarrierContent/s0:ExBatchNo,'-',s0:StatusCode)" />
        <xsl:if test="concat(s0:ContentLines/s0:CarrierContent/s0:CustomerItemNo,'-',s0:ContentLines/s0:CarrierContent/s0:ExpirationDate,'-',s0:ContentLines/s0:CarrierContent/s0:ExBatchNo,'-',s0:StatusCode) != '---'">
          <xsl:if test="sum(key('Group-by-MATNO-THT-BATCH-STATUS',$LineKey)/s0:ContentLines/s0:CarrierContent/s0:Quantity) &gt; 0">
            ...
            <ns0:LINLoop1>
              <ns0:LIN>
                ...
                <ns0:C212>
                  <C21201>
                    <xsl:value-of select="s0:ContentLines/s0:CarrierContent/s0:EANCode" />
                  </C21201>
                  <C21202>SRV</C21202>
                </ns0:C212>
              </ns0:LIN>
              ...
              <ns0:INVLoop1>
                ...
                <ns0:QTY_2>
                  <ns0:C186_2>
                    ...
                    <C18602>
                      <xsl:value-of select="sum(key('Group-by-MATNO-THT-BATCH-STATUS',$LineKey)/s0:ContentLines/s0:CarrierContent/s0:Quantity)" />
                    </C18602>
                    <C18603>EDU</C18603>
                  </ns0:C186_2>
                </ns0:QTY_2>
                <ns0:GIN_2>
                  ...
                  <ns0:C208_6>
                    <C20801>
                      <xsl:value-of select="substring(s0:ContentLines/s0:CarrierContent/s0:ExBatchNo,1, 10)"/>
                    </C20801>
                  </ns0:C208_6>
                </ns0:GIN_2>
                <ns0:LOC_3>
                ...
                <ns0:DTM_8>
                  <ns0:C507_8>
                    <C50701>361</C50701>
                    <C50702>
                      <xsl:value-of select="MyScript:ParseDate(s0:ContentLines/s0:CarrierContent/s0:ExpirationDate, 'yyyy-MM-dd', 'yyyyMMdd')" />
                    </C50702>
                    <C50703>102</C50703>
                  </ns0:C507_8>
                </ns0:DTM_8>
