		...
		<ns0:EFACT_D16B_DESADV>
			...
			<ns0:NADLoop1>
				<ns0:NAD>
					...
					<ns0:C080>
						<C08001>
							<xsl:value-of select="MyScript:ToUpper(MyScript:TrimEnd(MyScript:RemoveDiacritics(s0:ShipToAddress/s0:Name)))" />
						</C08001>
					</ns0:C080>
				</ns0:NAD>
			</ns0:NADLoop1>
							...
							<ns0:PCILoop2>
								...
								<ns0:GINLoop2>
									<ns0:GIN_3>
										...
										<ns0:C208_12>
											<C20801>
												<xsl:value-of select="translate(s0:ExternalBatchNo, '~', '')"/>
											</C20801>
										</ns0:C208_12>
									</ns0:GIN_3>
								</ns0:GINLoop2>
