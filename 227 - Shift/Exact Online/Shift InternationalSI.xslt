<xsl:stylesheet version="1.0"
  ...
  xmlns:s0="www.boltrics.nl/sendsalesinvoiceledger:v1.00"
	exclude-result-prefixes = "userCSharp msxsl xsl" >
	<xsl:output method="xml" indent="yes" version="1.0" />

	<xsl:variable name="test" select="/s0:Message/s0:SalesInvoices/s0:SalesInvoice/s0:CustomerLedgerEntries[1]/s0:CustLedgerEntry[1]/s0:Amount[1]" />
	<xsl:variable name="WmsDocNo" select="/s0:Message/s0:SalesInvoices/s0:SalesInvoice/s0:GLEntries/s0:GLEntry[1]/s0:WMSDocumentNo"/>
	...
	<xsl:template match="/">
		<xsl:for-each select="//s0:Message/s0:SalesInvoices/s0:SalesInvoice">
			<eExact  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:s0="www.boltrics.nl/sendsalesinvoiceledger:v1.00">
				<GLTransactions>
              ...
              <Description>Sales entry</Description>
						...
						<Journal>
							<xsl:attribute name="code" >700</xsl:attribute>
                ...
                <YourRef>
                  <xsl:value-of select="s0:No"/>
						...
						<Account>
							...
							</xsl:attribute> <!--translate(s0:No,translate(s0:No,'0123456789',''),'')-->
							<Name>
						...
						<xsl:for-each select="s0:GLEntries/s0:GLEntry">
							<GLTransactionLine>
								<xsl:attribute name="line">20</xsl:attribute>
								<Date>
                    ...
                    <xsl:attribute name="code" >
                      <xsl:value-of select="s0:GlobalDimension2Code"/>
								...
								<Amount>
									<Currency>
										<xsl:attribute name="code" >
											<xsl:value-of select="//s0:CustomerLedgerEntries/s0:CustLedgerEntry/s0:CurrencyCode"/>
										</xsl:attribute>
									</Currency>
									<Value>
