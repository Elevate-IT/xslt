    ...
    <ns0:Message>
      <ns0:Header>
        ...
        <ns0:FromTradingPartner>
          <xsl:choose>
            <xsl:when test="substring(UNB/UNB2.1, 1, 13) != '5488888012257'">
              <xsl:value-of select="substring(UNB/UNB2.1, 1, 13)" />
            </xsl:when>
            <xsl:otherwise>
      ...
      <ns0:Documents>
        <ns0:Document>
          ...
          <ns0:DeliveryDate>
            <!--Eigenlijk requested delivery date-->
            ...
            <ns0:DocumentLines>
              <xsl:for-each select="//s0:LINLoop1">
                <ns0:DocumentLine>
                  ...
                  <ns0:GTIN>
                    <xsl:value-of select="s0:LIN[s0:C212/C21202 = 'EN']/s0:C212/C21201"/>
                  </ns0:GTIN>
                  <ns0:OrderQuantity>
                  ...
                  <!--<ns0:OrderUnitofMeasureCode>
										-->
                  <!--todo komt nog niet goed door bij edi > xml-->
                  <!--
										<xsl:value-of select="s0:QTY/s0:C186/C18603"/>
									</ns0:OrderUnitofMeasureCode>-->
