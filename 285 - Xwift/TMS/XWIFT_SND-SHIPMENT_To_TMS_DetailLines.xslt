      ...
      <Dossier>
        ...
        <Missions>
          <Mission>
            ...
            <Products>
              <xsl:for-each-group select="s0:DocumentLines/s0:DocumentLine/s0:DocumentDetailLines/s0:DocumentDetailLine" group-by="s0:CarrierNo" >
                <Product>
                  <SequenceNumber>
                  ...
                  <xsl:if test="s0:Length != '0'">
                    <Length>
                      <xsl:value-of select="s0:Length" />
                    </Length>
                  </xsl:if>
                  <xsl:if test="s0:Width != '0'">
                    <Width>
                      <xsl:value-of select="s0:Width" />
                    </Width>
                  </xsl:if>
                  <xsl:if test="s0:Height != '0'">
                    <Height>
                      <xsl:value-of select="s0:Height" />
                    </Height>
                  </xsl:if>
                </Product>
              </xsl:for-each-group>
