    ...
    <ns0:Message>
      <ns0:Header>
        ...
        <ns0:FromTradingPartner>
          <xsl:value-of select="UNH/Sender" />
        </ns0:FromTradingPartner>
      ...
      <ns0:Documents>
        <xsl:for-each select="DELIVERY">
          <xsl:variable name="FirstLoadCarRunSeq">
            <xsl:value-of select="DespatchData/FirstLoadCarRunSeq" />
          </xsl:variable>
          <ns0:Document>
            <ns0:BuildingCode>
              <xsl:choose>
                <xsl:when test="DespatchData[CarrierRunSeqId = $FirstLoadCarRunSeq]/PickingInstructions = '100'">
                  <xsl:text>TURNHOUT 1</xsl:text>
                </xsl:when>
                <xsl:when test="DespatchData[CarrierRunSeqId = $FirstLoadCarRunSeq]/PickingInstructions = '900'">
                  <xsl:text>BL</xsl:text>
                </xsl:when>
                <xsl:when test="DespatchData[CarrierRunSeqId = $FirstLoadCarRunSeq]/PickingInstructions = '1993'">
            ...
            <ns0:ExternalDocumentNo>
              <xsl:value-of select="concat(DespatchData/CarrierRunId, '-', CallOffData/DeliveryAddressId)" />
            </ns0:ExternalDocumentNo>
            ...
            <ns0:DocumentLines>
              <xsl:for-each select="DespatchData/PalletsDespatch" >
                <xsl:variable name="PalletsDespatch" select="." />
                <xsl:variable name="DeliveryLineID" select="../DeliveryLineId" />
                
                <xsl:for-each select="../../CallOffData[DeliveryLineId = $DeliveryLineID]">
                  <ns0:DocumentLine>
                    <ns0:No>
                    ...
                    <ns0:OrderQuantity>
                      <xsl:value-of select="$PalletsDespatch/NumberOfPiecesPerPallet * $PalletsDespatch/NumberOfPallets" />
                    </ns0:OrderQuantity>
                    <ns0:QtyPerCarrier>
                      <xsl:value-of select="$PalletsDespatch/NumberOfPiecesPerPallet" />
                    </ns0:QtyPerCarrier>
                    <ns0:BuildingCode>
                      <xsl:choose>
                        <xsl:when test="../DespatchData[DeliveryLineId = $DeliveryLineID]/PickingInstructions = '100'">
                          <xsl:text>TURNHOUT 1</xsl:text>
                        </xsl:when>
                        <xsl:when test="../DespatchData[DeliveryLineId = $DeliveryLineID]/PickingInstructions = '900'">
                          <xsl:text>BL</xsl:text>
                        </xsl:when>
                        <xsl:when test="../DespatchData[DeliveryLineId = $DeliveryLineID]/PickingInstructions = '1993'">
                          <xsl:text>VOORKAAI</xsl:text>
                        </xsl:when>
                      </xsl:choose>
                    </ns0:BuildingCode>
                    <ns0:Attributes>
                      ...
                      <ns0:Attribute>
                        ...
                        <ns0:Value>
                          <xsl:value-of select="../DespatchData[DeliveryLineId = $DeliveryLineID]/PalletsPerCombination[PalletType = 'G'][1]/PalletAgreement"/>
                        </ns0:Value>
                      </ns0:Attribute>
                      <ns0:Attribute>
                        <ns0:Code>
                        ...
                        <ns0:Value>
                          <xsl:value-of select="../DespatchData[DeliveryLineId = $DeliveryLineID]/PalletsPerCombination[PalletType = 'T'][1]/PalletAgreement"/>
                        </ns0:Value>
                      </ns0:Attribute>
                      <ns0:Attribute>
                        <ns0:Code>
                          <xsl:text>SK_PA_GRD2</xsl:text>
                        </ns0:Code>
                        <ns0:Value>
                          <xsl:value-of select="../DespatchData[DeliveryLineId = $DeliveryLineID]/PalletsPerCombination[PalletType = 'G'][2]/PalletAgreement"/>
                        </ns0:Value>
                      </ns0:Attribute>
                      <ns0:Attribute>
                        <ns0:Code>
                          <xsl:text>SK_PA_TOP2</xsl:text>
                        </ns0:Code>
                        <ns0:Value>
                          <xsl:value-of select="../DespatchData[DeliveryLineId = $DeliveryLineID]/PalletsPerCombination[PalletType = 'T'][2]/PalletAgreement"/>
                        </ns0:Value>
                      </ns0:Attribute>
                      <ns0:Attribute>
                        <ns0:Code>
