<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:key name="Group-by-ITEM-BATCH-STATUS-TYPE" match="//s0:Message/s0:Customers/s0:Customer/s0:Adjustments/s0:Adjustment" use="concat(s0:CustomerItemNo,'-',s0:ExternalBatchNo,'-',MyScript:ConvertStatusCode(s0:Carrier/s0:StatusCode),'-',s0:MutationType)" />
  <xsl:template match="/">
  ...
  <xsl:template match="//s0:Message/s0:Customers/s0:Customer">
    <ns0:EFACT_D96A_INVRPT>
      ...
      <ns0:BGM>
        ...
        <BGM04>
          <xsl:value-of select="//s0:Adjustments/s0:Adjustment/s0:ReasonCode" />
        </BGM04>
      </ns0:BGM>
      <ns0:DTM>
        <ns0:C507>
      ...
      <xsl:choose>
        <xsl:when test="//s0:Adjustments/s0:Adjustment/s0:ReasonCode != 'LC'">
          <xsl:for-each select="//s0:Adjustment[count(. | key('Group-by-ITEM-BATCH-STATUS-TYPE', concat(s0:CustomerItemNo,'-',s0:ExternalBatchNo,'-',MyScript:ConvertStatusCode(s0:Carrier/s0:StatusCode),'-',s0:MutationType))[1]) = 1]">
            <xsl:variable name="LineKey" select="concat(s0:CustomerItemNo,'-',s0:ExternalBatchNo,'-',MyScript:ConvertStatusCode(s0:Carrier/s0:StatusCode),'-',s0:MutationType)" />
            <xsl:if test="concat(s0:CustomerItemNo,'-',s0:ExternalBatchNo,'-',MyScript:ConvertStatusCode(s0:Carrier/s0:StatusCode),'-',s0:MutationType) != '---'">
              <ns0:LINLoop1>
                <ns0:LIN>
                  <LIN01>
                ...
                <ns0:QTYLoop2>
                  <ns0:QTY_2>
                    <ns0:C186_2>
                      <C18601>
                        <xsl:choose>
                          <xsl:when test="s0:MutationType = 'Negative'">06</xsl:when>
                          <xsl:when test="s0:MutationType = 'Positive'">56</xsl:when>
                        </xsl:choose>
                      </C18601>
                      <C18602>
                        <xsl:value-of select="MyScript:Abs(sum(key('Group-by-ITEM-BATCH-STATUS-TYPE',$LineKey)/s0:Quantity))" />
                      </C18602>
                      <C18603>CS</C18603>
                    </ns0:C186_2>
                  </ns0:QTY_2>
                  <ns0:INV>
                    <INV01>
                      <xsl:value-of select="MyScript:ConvertStatusCode(s0:Carrier/s0:StatusCode)" />
                    </INV01>
                  </ns0:INV>
                  <ns0:RFFLoop4>
                    <ns0:RFF_4>
        ...
        <xsl:otherwise>
          <xsl:for-each select="//s0:Adjustment[s0:MutationType = 'Negative']">
            <xsl:variable name="RelatedEntryNo">
              <xsl:value-of select="s0:RelatedEntryNo"/>
            </xsl:variable>
            <ns0:LINLoop1>
              <ns0:LIN>
                <LIN01>
              ...
              <ns0:QTYLoop2>
                <ns0:QTY_2>
                  <ns0:C186_2>
                    ...
                    <C18602>
                      <xsl:value-of select="MyScript:Abs(s0:Quantity)" />
                    </C18602>
                    <C18603>CS</C18603>
                  </ns0:C186_2>
                </ns0:QTY_2>
              ...
              <ns0:QTYLoop2>
                <ns0:QTY_2>
                  <ns0:C186_2>
                    <C18601>
                      <xsl:choose>
                        <xsl:when test="//s0:Adjustment[s0:MutationType = 'Positive'][s0:EntryNo = $RelatedEntryNo]/s0:MutationType = 'Negative'">06</xsl:when>
                        <xsl:when test="//s0:Adjustment[s0:MutationType = 'Positive'][s0:EntryNo = $RelatedEntryNo]/s0:MutationType = 'Positive'">56</xsl:when>
                      </xsl:choose>
                    </C18601>
                    <C18602>
                      <xsl:value-of select="MyScript:Abs(//s0:Adjustment[s0:MutationType = 'Positive'][s0:EntryNo = $RelatedEntryNo]/s0:Quantity)" />
                    </C18602>
                    <C18603>CS</C18603>
                  </ns0:C186_2>
                </ns0:QTY_2>
                <ns0:INV>
                  <INV01>
                    <xsl:value-of select="MyScript:ConvertStatusCode(//s0:Adjustment[s0:MutationType = 'Positive'][s0:EntryNo = $RelatedEntryNo]/s0:Carrier/s0:StatusCode)" />
                  </INV01>
                </ns0:INV>
                <ns0:RFFLoop4>
                  <ns0:RFF_4>
                    <ns0:C506_4>
                      <C50601>84</C50601>
                      <C50602>
                        <xsl:value-of select="//s0:Adjustment[s0:MutationType = 'Positive'][s0:EntryNo = $RelatedEntryNo]/s0:ExternalBatchNo"/>
                      </C50602>
                    </ns0:C506_4>
                  </ns0:RFF_4>
