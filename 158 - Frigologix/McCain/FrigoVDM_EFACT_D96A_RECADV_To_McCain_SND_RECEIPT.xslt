      ...
      <ns0:RFFLoop1>
        <ns0:RFF>
          <ns0:C506>
            <C50601>ON</C50601>
            <C50602>
              <xsl:value-of select="translate(s0:ExternalReference,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ')" />
            </C50602>
          </ns0:C506>
        </ns0:RFF>
      </ns0:RFFLoop1>
          ...
          <ns0:CPSLoop1>
            ...
            <ns0:LINLoop1>
              <ns0:LIN>
                ...
                <ns0:C212>
                  <C21201>
                    <xsl:value-of select="format-number(s0:EANCode, '00000000000000')" />
                  </C21201>
                  <C21202>EN</C21202>
                </ns0:C212>
              </ns0:LIN>
                ...
                <ns0:CDILoop9>
                  <ns0:CDI_12>
                    ...
                    <ns0:C564_12>
                      <C56401>
                        <xsl:choose>
                          <xsl:when test="//s0:Carrier[s0:No = $CarrierNo]/s0:StatusCode = '90-BLOQUE'">7</xsl:when>
                          <xsl:when test="//s0:Carrier[s0:No = $CarrierNo]/s0:StatusCode = '50-COOL DOWN'">5</xsl:when>
                          <xsl:when test="//s0:Carrier[s0:No = $CarrierNo]/s0:StatusCode = '51-CUSTOMER RETURN'">5</xsl:when>
                          <xsl:when test="//s0:Carrier[s0:No = $CarrierNo]/s0:StatusCode = '52-QI EXPORT'">5</xsl:when>
