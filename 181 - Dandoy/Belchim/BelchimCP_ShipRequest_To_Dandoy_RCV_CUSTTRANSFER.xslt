<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ns0="www.boltrics.nl/receivecustomertransfer:v1.00"
    ...
    <ns0:Message>
      ...
      <ns0:Documents>
        <ns0:Document>
          ...
          <ns0:CustomerNoNew>
            <xsl:choose>
              <xsl:when test="Recipient/AccountNo = 'BE-C0006DANDOY'">ACTU7522K</xsl:when>
              <xsl:otherwise>
          ...
          <ns0:PlannedStartDate>
            <xsl:value-of select="MyScript:AddDays(RequestedShipmentDate, '-1', 'yyyy-MM-dd')" />
          </ns0:PlannedStartDate>
          <ns0:DeliveryDate>
            ...
            <ns0:DocumentLines>
              <xsl:for-each select="//Position">
                <ns0:DocumentLine>
                  ...
                  <ns0:OrderQuantity>
                    <xsl:value-of select="QuantityBase" />
                  </ns0:OrderQuantity>
  ...
  <msxsl:script language="C#" implements-prefix="MyScript">
    <![CDATA[			
      ...
      public string AddDays(string inputDate, string formulaText, string formatOut)
      {
        DateTime Date = System.Convert.ToDateTime(inputDate);
