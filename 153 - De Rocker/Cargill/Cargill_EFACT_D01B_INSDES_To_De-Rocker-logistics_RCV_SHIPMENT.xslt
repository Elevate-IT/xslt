    ...
    <ns0:Message>
      ...
      <ns0:Documents>
        <ns0:Document>
          ...
          <ns0:DeliveryDate>
            <xsl:value-of select="MyScript:ParseDate(s0:DTM/s0:C507[C50701 = '69']/C50702,'yyyyMMdd','yyyy-MM-dd')" />
          </ns0:DeliveryDate>
          <ns0:PostingDate>
            <xsl:value-of select="MyScript:ParseDate(s0:DTM/s0:C507[C50701 = '76']/C50702,'yyyyMMdd','yyyy-MM-dd')" />
          </ns0:PostingDate>
          ...
          <ns0:Attributes>
            ...
            <ns0:Attribute>
              ...
              <ns0:Value>
                <xsl:value-of select="s0:BGM/s0:C002[C00201 = '350']/C00204" />
              </ns0:Value>
            </ns0:Attribute>
          </ns0:Attributes>
          ...
          <xsl:if test="count(s0:LINLoop1) &gt; 0">
            <ns0:DocumentLines>
              <xsl:for-each select="//s0:LINLoop1[count(. | key('Group-by-Item_UOM_Batch', concat(s0:PIA[s0:C212_2/C21202 = 'SA']/s0:C212_2/C21201, '-', s0:QTY/s0:C186/C18603, '-', s0:PIA[s0:C212_2/C21202 = 'BB']/s0:C212_2/C21201))[1]) = 1]">
                <xsl:variable name="LineKey" select="concat(s0:PIA[s0:C212_2/C21202 = 'SA']/s0:C212_2/C21201, '-', s0:QTY/s0:C186/C18603, '-', s0:PIA[s0:C212_2/C21202 = 'BB']/s0:C212_2/C21201)" />
                <xsl:if test="concat(s0:PIA[s0:C212_2/C21202 = 'SA']/s0:C212_2/C21201, '-', s0:QTY/s0:C186/C18603, '-', s0:PIA[s0:C212_2/C21202 = 'BB']/s0:C212_2/C21201) != '--'">
                  <ns0:DocumentLine>
                    <ns0:ExternalNo>
                      <xsl:value-of select="key('Group-by-Item_UOM_Batch',$LineKey)/s0:PIA[s0:C212_2/C21202 = 'SA']/s0:C212_2/C21201"/>
                    </ns0:ExternalNo>
                    <ns0:OrderQuantity>
                      <xsl:choose>
                        <xsl:when test="key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18603 = 'TNE'">
                          <xsl:value-of select="format-number(sum(key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18602) * 1000, '#.###')" />
                        </xsl:when>
                        <xsl:when test="key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18603 = 'MT'">
                          <xsl:value-of select="format-number(sum(key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18602) * 1000, '#.###')" />
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of select="format-number(sum(key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18602), '#.###')" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </ns0:OrderQuantity>
                    <ns0:OrderUnitofMeasureCode>
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <xsl:value-of select="key('Group-by-Item_UOM_Batch',$LineKey)/s0:QTY/s0:C186/C18603" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </ns0:OrderUnitofMeasureCode>
                    <xsl:if test="key('Group-by-Item_UOM_Batch',$LineKey)/s0:PIA[s0:C212_2/C21202 = 'BB']/s0:C212_2/C21201 != ''">
                      <ns0:ExternalBatchNo>
                        <xsl:value-of select="key('Group-by-Item_UOM_Batch',$LineKey)/s0:PIA[s0:C212_2/C21202 = 'BB']/s0:C212_2/C21201" />
                      </ns0:ExternalBatchNo>
                    </xsl:if>
                    <ns0:Attributes>
                      <ns0:Attribute>
                        ...
                        <ns0:Value>
                          <xsl:value-of select="key('Group-by-Item_UOM_Batch',$LineKey)/s0:LIN/LIN01" />
                        </ns0:Value>
                      </ns0:Attribute>
                      <ns0:Attribute>
